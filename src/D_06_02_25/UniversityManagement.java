...
public class UniversityManagement {
    public static void main(String[] args) {
        Professor professor1 = new Professor("Dr. Shubham");
        Professor professor2 = new Professor("Dr. Vinay");
        ...
        Student student1 = new Student("Archi");
        Student student2 = new Student("Bhuvan");
